...
class Column(pygame.sprite.Sprite):
    ...
    def get_gap_center_y(self):
        return self.rect.y + self.sprite_rect.height + self.gap // 2

    def get_distance_from_center(self, bird_y):
        return abs(bird_y - self.get_gap_center_y())
